...
public class UpdateUserWithUserProfile extends CustomJavaAction<IMendixObject>
{
	private IMendixObject __userProfile;
	private mendixsso.proxies.UserProfile userProfile;

	public UpdateUserWithUserProfile(IContext context, IMendixObject userProfile)
	{
		super(context);
	...
	public IMendixObject executeAction() throws Exception
	{
		...
		// BEGIN USER CODE
		return UserMapper.getInstance().updateUser(getContext(), userProfile);
		// END USER CODE
	}
	...
	{
		return "UpdateUserWithUserProfile";
	}
